...
(function ($)
{
    ...
    function Plugin($container, options)
    {
        ...
        var self            = this
        ,   $viewport       = $container.find(this.options.container)
        ,   $overview       = $container.find(this.options.overview)
        ,   $slides         = $overview.children()
        ,   $thumb          = $container.find(this.options.thumb)
        ,   $dots           = $container.find(this.options.dot)
        ,   $links          = $slides.find("a")
        ...
        function setEvents()
        {
            ...
            if(self.options.dotsSnap)
            {
                $container.delegate(options.dot, eventType, function(event)
                {
        ...
        function setDots()
        {
            ...
            $slides.each(function(index, slide)
            {
                ...
                ;
                $dotClone.addClass($(slide).attr("data-classname")).addClass("dot");
            ...
            $dots = $container.find(options.dot);
        }
